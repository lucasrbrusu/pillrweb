...
3. Insert that auth user into `public.admin_users` using the commented seed block in the SQL file.
4. Copy your real project values into `admin/js/config.js`:
   - `SUPABASE_URL`
   - `SUPABASE_ANON_KEY`
5. Deploy the Edge Functions inside `supabase/functions/`.
